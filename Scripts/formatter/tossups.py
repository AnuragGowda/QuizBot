...
all of the tossups that quizDb has into seperate json files. (Also these aren't
really proper JSON objects, but I just refer to them as such) The reason I had
